...
$capabilities = array(
    ...
    /* Voluntarily unenrol token from course - watch out for data loss. */
    'enrol/token:unenrolself' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_COURSE,
        'archetypes' => array(
            'student' => CAP_ALLOW,
